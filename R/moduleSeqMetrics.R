  ...
  tagList(
    ...
    div(
      ...
      p(
        ...
        "Scores were summed, with higher scores indicating greater expected isoform resolution. Scores of 0-2 were classified as low confidence, scores of 3-4 as medium confidence, and scores of 5 as high confidence."
      )
    ),
